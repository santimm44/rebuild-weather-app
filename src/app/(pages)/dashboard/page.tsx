...
//   const [weatherLowTempVar, setWeatherLowTempVar] = useState<number>(0)
  
//   useEffect(() => {
//     const fetchFunctions = async () => {
//       returnedData = await servifiveDayWeatherInformationce()
//       weatherForecastVariable = await weatherForecast()
